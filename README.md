...
- **Flattening Images:**  
  Each 28 × 28 image was reshaped into a 784-dimensional vector.

- **Feature Scaling:**  
  Pixel values were normalized by dividing by 255 to scale the range from **[0–255] to [0–1]**.
...
- **Hidden Layers:** 3 Dense layers with ReLU and Sigmoid activations  
